...
if ENV:
    ...
    class Config(object):
        ...
        G_BAN_LOGGER_GROUP = int(os.environ.get("G_BAN_LOGGER_GROUP", -1001115810044))
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/SKULLUB/SkullUserbot"
        )
        ...
        EXTRA_SKULLBOT = os.environ.get("EXTRA_SKULLBOT", -1001115810044)
