...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "SkullBot")
        ...
        WHITELIST_USERS = set(
            int(x) for x in os.environ.get("WHITELIST_USERS", "997887920").split()
        )
        BLACKLIST_USERS = set(
        ...
        OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "997887920").split())
        SUPPORT_USERS = set(
            int(x) for x in os.environ.get("SUPPORT_USERS", "997887920").split()
        )
