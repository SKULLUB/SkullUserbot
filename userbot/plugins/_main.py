...
bot = "@MissElisaBot"
start = "Hi Boss "
ERRORS = ["**sed**", "U Are Not A Valid Human", "U Are Not permitted", "Get Lost"]
end = "....\nThis Is Ur Personal Assistant : Skull....I am Here To Help U With Ur Daily Works.."
Vid = [
    "/videos__page1",
    "/videos__page2",
    "/videos__page3",
        ...
        async with borg.conversation("@Cryptowhalebot") as y:
            try:
                ...
                await cmd.client.send_file(
                    cmd.chat_id,
                    meme,
                    caption="<< Here's Your Carbon 😉,\nCarbonised By [SKULL](https://www.github.com/SKULLUB/SkullUserbot)>> ",
                    force_document=True,
                )
                await cmd.delete()
            except YouBlockedUserError:
